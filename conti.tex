...
So we generate:
\[
C_S\equiv  2 G_{B'} \lambda_{B'}^q \lambda_{B'}^l \quad C_T \equiv 2G_{W'} \lambda_{W'}^q \lambda_{W'}^l \quad C_{LR1} \equiv 2 G_{B'} \lambda_{B'}^q \lambda_{B'}^e \quad C_{LR2}^{u/d} 2 G_{B'} \lambda_{B'}^{u/d} \lambda_{B'}^l
\]
