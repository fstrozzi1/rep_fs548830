...
\[
R_{K^*} =|1+ \frac{C_S^{bs \mu \mu} + C_T^{bs\mu \mu}}{C_{SM}}   |^2= 1 + 2 \frac{C_S^{bs \mu \mu} +C_T^{bs\mu \mu}}{C_{SM}} + \bigg|\frac{C_S^{bs \mu \mu} +C_T^{bs\mu \mu}}{C_{SM}}\bigg|^2
\]
...
\[
R_{D}= \frac{| C_{SM} + 2C_T^{bs\tau \tau} V_{cs}^* +2C_T^{bb\tau \tau} V_{cb}^*|^2 +|2C_T^{bs\tau \mu} V_{cs}^* + 2C_T^{bb \tau \mu} V_{cb}^* |^2 }{\frac{1}{2} \big[ |C_{SM}|^2 + |C_{SM} + 2C_T^{bs\mu \mu} V_{cs}^* + 2C_T^{bb\tau \tau} V_{cb}^*|^2  +  |2C_T^{bs\mu \tau} V_{cs}^* + 2C_T^{bb\mu \tau} V_{cb}^*|^2 \big]}
\]
